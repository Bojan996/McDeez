    ...
    return (
        <div className='HistoryContainer'>
            ...
            <div className='HistoryContentSection'>
                ...
                <div className='HistorySecondDiv'>
            ...
            <div className='HistoryLinkSection'>
                <h1>Let's go and enjoy McDeez services</h1>
                <div className='HistoryLinkContent'>
                    <div>
                        <p onClick={() => props.history.push('/foodmaker')}>Try our Menu</p>
                    </div>
                    <div>
                        <p onClick={() => props.history.push('/locations')}>See our Locations</p>
                    </div>
                    <div>
                        <p onClick={() => props.history.push('/careers')}>Go to Careers</p>
                    </div>
                    <div>
                        <p onClick={() => props.history.push('/')}>Checkout Home</p>
                    </div>
                </div>
            </div>
