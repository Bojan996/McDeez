...
class Careers extends Component {
  ...
  formSubmitHandler = (event) => {
    ...
    if (
      this.state.inputInfo.email.includes("@") &&
      this.state.inputInfo.email.includes(".")
    ) {
      ...
      setTimeout((e) => {
        ...
        this.props.enqueueSnackbar("Your message has been sent!", {
          variant: "success",
        });
        setTimeout((e) => {
            ...
            <form className="CareersFormDivContentForm">
              ...
              <div className="CareersFormEmailAge">
                ...
                <TextField
                  ...
                  variant="outlined"
                  className="CareersFormInput"
                  onChange={(event) => this.inputHandler(event, "age")}
                />
              </div>
              <TextField
                id="outlined-basic"
                ...
                multiline={true}
                rows="5"
                onChange={(event) => this.inputHandler(event, "comment")}
              />
              <button
